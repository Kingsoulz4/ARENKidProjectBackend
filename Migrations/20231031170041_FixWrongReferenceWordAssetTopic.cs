...
{
    /// <inheritdoc />
    public partial class FixWrongReferenceWordAssetTopic : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameAsset = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WordAssetID = table.Column<long>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LevelAge = table.Column<int>(type: "INTEGER", nullable: false),
                    TopicDataID = table.Column<long>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WordAssetData_TopicData_TopicDataID",
                        column: x => x.TopicDataID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WordAssetData_TopicDataID",
                table: "WordAssetData",
                column: "TopicDataID");
